...
As a player, I want enemies to move along a predefined path so I can predict their movement.
- Epic 2: Progression & Difficulty
As a player, I want waves of enemies to become progressively harder so that the game remains challenging.
As a player, I want to earn in-game currency for defeating enemies so I can upgrade my towers.
...
As an artist, I want to design visually distinct enemy types so players can recognize threats easily.
As a UI designer, I want to create a pause menu where players can restart or change settings.
-- Epic 4: Sound & Feedback
As a player, I want sound effects when I place towers and when enemies are defeated so I get immediate feedback.
